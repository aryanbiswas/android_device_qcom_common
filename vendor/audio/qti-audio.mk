...
-include $(TOPDIR)hardware/qcom-caf/$(BOARD_VARIANT)/audio/configs/msmsteppe/msmsteppe.mk
# Flag for inheriting audio_vendor_product.mk on >4.19 targets
else ifeq (,$(filter 3.18 4.4 4.9 4.14 4.19, $(TARGET_KERNEL_VERSION)))
-include $(TOPDIR)hardware/qcom-caf/$(BOARD_VARIANT)/audio/configs/audio_vendor_product.mk
else
-include $(TOPDIR)hardware/qcom-caf/$(BOARD_VARIANT)/audio/configs/$(TARGET_BOARD_PLATFORM)/$(TARGET_BOARD_PLATFORM).mk
endif
